...
class VrptwGraph:
    def __init__(self, file_path, rho=0.1, Q=1):
        super()
        ...
        self.initial_pheromone = self.init_pheromone_val
    ...
    def create_from_file(self, file_path):
        # Baca lokasi titik layanan dan pelanggan dari file
        node_list = []
    ...
    def global_update_pheromone(self, paths, path_distances):
    # Penguapan feromon global
        ...
        for path, path_distance in zip(paths, path_distances):
            # Perhitungan penambahan feromon baru
            delta_pheromone = self.Q / path_distance
    ...
    def _cal_nearest_next_index(self, index_to_visit, current_index, current_load, current_time):
        """
        Temukan next_index terdekat yang dapat dijangkau
        ...
        for next_index in index_to_visit:
            ...
            # Tidak dapat melayani penumpang diluar waktu yang telah ditentukan
